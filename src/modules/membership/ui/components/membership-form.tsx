  ...
  return (
    <form onSubmit={handleSubmit} className="bg-gray-900 p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
        ...
        <div>
          <label htmlFor="country" className="block text-champagne text-sm mb-2">
        ...
        <div>
          <label htmlFor="membershipType" className="block text-champagne text-sm mb-2">
        ...
        <div>
          <label htmlFor="organization" className="block text-champagne text-sm mb-2">
