    ...
    return (
      <main className="min-h-screen bg-background">
        <div className="pt-32 pb-24 text-center">
          <h1 className="text-4xl font-bold text-[#c18f2c] mb-4">Category Not Found</h1>
      ...
      <section className="py-16 bg-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center">
            <Link
              href="/prizes"
              className="px-8 py-4 border border-[#c18f2c]/30 text-[#c18f2c] font-medium tracking-wide hover:border-primary hover:text-primary transition-colors text-center"
            >
              View All Categories
            </Link>
          </div>
